...
export function StageInteraction() {
  ...
  const [vc] = useState(new InteractionViewController(playerManger, draftManager, editorManager))
  ...
  return <div ref={interactionRef} className="size-full absolute left-0 top-0"></div>
}
